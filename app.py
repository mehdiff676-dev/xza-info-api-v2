...
def get_account_credentials(region: str) -> str:
    ...
    if r == "ME":
        return "uid=4327530508&password=CTX_MASRY_ECCFK9WCNXFPPKHXS4UU4YTXV"
    elif r == "BD":
...
if __name__ == '__main__':
    ...
    # When using gunicorn, this app.run() part is not used in production.
    # However, it's good practice to keep it for local testing.
